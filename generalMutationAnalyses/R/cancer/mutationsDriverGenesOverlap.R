...
# Doing permutations
permResults <- superApply(1:nPerm, singlePermutation,
                    # Super apply pars
                    tasks = 10, partition = "hbfraser,owners,hns", time = "2:00:00", mem = "8G", proc = 1, 
                    packages = "", clean = T,
...
#permResults <- lapply(1:10, singlePermutation,
#                    # Function pars
#                    mutationsDriver = mutationsDriver, mutationsDriverRandom = mutationsDriverRandom, 
#                    uniqDrivers = uniqDrivers, randomDrivers = randomDrivers, newRandomPerIteration = T, 
#                    geneExp = geneExp, mutationsPerGene = mutationsPerGene)
