library("purrr")
map_file <- "/scratch/users/paedugar/somaticMutationsProject/mutationCount/filtered/Whole_Blood/n6_0.0_0.7/SRR2170217.txt"
map_files <- list.files("/scratch/users/paedugar/somaticMutationsProject/mutationCount/filtered/Whole_Blood/n6_0.0_0.7/", full = T)[1:100]
