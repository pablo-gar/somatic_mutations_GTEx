...
main <- function(cmdArgs = commandArgs(T)) {
    ...
    # DEBUG
    #dnds_file <-  "/scratch/users/paedugar/somaticMutationsProject/cancer/dndsout_tissuesMerged_noFalsePos/n6_0.0_0.7/dndsout_sel_loc.txt"
    #mutation_dir <- "/scratch/users/paedugar/somaticMutationsProject/cancer/driverMutations/mutations/n6_0.0_0.7"
    #expression_dir <- "/scratch/users/paedugar/somaticMutationsProject/cancer/driverMutations/expression/n6_0.0_0.7"
    #out_prefix <- "/scratch/users/paedugar/somaticMutationsProject/cancer/driverGeneralPlots/n6_0.0_0.7/"
    ...
    p_dnds_box <- plot_dnds_boxplots(dnds, mutations, n_mutations_cutoff = 5, out_prefix = out_prefix, n_perm = 1000, FUN_stat = mean) 
    p_dnds_box_info <- p_dnds_box[[1]]
    p_dnds_box <- p_dnds_box[[2]]
...
plot_dnds_boxplots <- function(dnds, mutations, n_mutations_cutoff = 5, out_prefix = out_prefix, FUN_stat = median, n_perm = 10000) {
    ...
    p <- ggplot(toPlot, aes(x = type, y = value)) +
