...
#args <- list.files("/scratch/users/paedugar/somaticMutationsProject/mutationCount/count/Liver/n6_0.0_0.7/", full = T)
...
write.table(stats, paste0(outplot, ".txt"), sep = "\t", col.names = T, row.names = F, quote = F)
